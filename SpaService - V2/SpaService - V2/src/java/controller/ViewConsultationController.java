...
public class ViewConsultationController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ViewConsultationController</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet ViewConsultationController at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
...
//        String userID = (String) session.getAttribute("userID");
        ...
        List<AppointmentDTO> appointments = dao.getAllAppointments();
        
        // Set the services list as a request attribute
        request.setAttribute("consultations", appointments);
