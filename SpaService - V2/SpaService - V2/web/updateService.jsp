...
<body class="bg-gradient-to-br from-pink-100 via-white to-pink-200 min-h-screen flex items-center justify-center p-4">
    <div class="bg-white w-full max-w-lg rounded-2xl shadow-2xl p-8 form-container relative">
        ...
        <h2 class="text-3xl font-bold text-center mb-8 text-primary relative z-10">Update Service</h2>
        
        <form action="UpdateServiceController" method="post" class="space-y-6 relative z-10">
            ...
            <div>
                ...
                <textarea name="description" rows="5" required
                          class="w-full px-4 py-3 rounded-xl bg-pink-50 border-transparent focus:border-primary focus:ring-2 focus:ring-primary focus:bg-white text-sm transition duration-300 transform hover:scale-105 hover:shadow-lg">${services.description}</textarea>
            </div>

            <div>
                <label for="price" class="text-sm font-medium text-gray-600 block mb-1">Price:</label>
                <input type="number" step="0.01" name="price" value="${services.price}" required
                       class="w-full px-4 py-3 rounded-xl bg-pink-50 border-transparent focus:border-primary focus:ring-2 focus:ring-primary focus:bg-white text-sm transition duration-300 transform hover:scale-105 hover:shadow-lg">
            </div>
